 ...
 * @author Rafael
 */
@WebServlet(name = "ControleProductArea", urlPatterns = {"/ControleProductArea"})
public class ControleProductArea extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, SQLException{
        response.setContentType("text/html;charset=UTF-8");
        
            if (request.getParameter("acao").contains("index")) {
            Pet p = new Pet();                      
            DaoPet daoPet = new DaoPet();
            List lstPet = daoPet.get();
            ...
            if (lstPet.isEmpty()) {
                ...
                RequestDispatcher redireciona = request.getRequestDispatcher("view/index.jsp");
                redireciona.forward(request, response);
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ControleProductArea.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
