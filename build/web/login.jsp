<%-- 
    Document   : login
    Created on : 13/05/2019, 22:48:01
    Author     : Rafael
--%>
                    ...
                    <div class="col-lg-6">
                        <div class="login_box_img">
                            ...
                            <div class="hover">
                                ...
                                <p>Clique abaixo e crie uma conta gratis</p>
                                <a class="main_btn" href="registration.jsp">CRIAR UMA CONTA</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <form class="row login_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="creat_account">
                                        ...
                                        <label for="f-option2">Mantenha-me logado</label>
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
